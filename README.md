...
3. Create a new environment and install requirements using `conda env update -n dem-stitcher --file environment.yml` (or use [`mamba`](https://github.com/mamba-org/mamba) to speed install up)
